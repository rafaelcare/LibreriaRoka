...
class OrderDetailsControllerTest < ActionController::TestCase
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post :create, order_detail: { cantidad: @order_detail.cantidad, descuento: @order_detail.descuento, importetotal: @order_detail.importetotal, order_id: @order_detail.order_id, preciounitario: @order_detail.preciounitario, product_id: @order_detail.product_id }
    end
  ...
  test "should update order_detail" do
    patch :update, id: @order_detail, order_detail: { cantidad: @order_detail.cantidad, descuento: @order_detail.descuento, importetotal: @order_detail.importetotal, order_id: @order_detail.order_id, preciounitario: @order_detail.preciounitario, product_id: @order_detail.product_id }
    assert_redirected_to order_detail_path(assigns(:order_detail))
  end
